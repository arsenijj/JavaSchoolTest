...
public class Main {
    ...
    public static void main(String... args){
        ...
        String r1 = a.execute("INSERT VALUES 'lastName' = 'Федоров1', 'id' = 1, 'age' = 10, 'active' = true, 'cost' = 3.1;");
        ...
        String b = a.execute("select age, lastName, cost where active = true or age >= 10 or cost < 10 or lastName like 'su4ka' or age > 1 or cost > 10 and cost < 1000");
